...
<div class="col-sm-9 col-md-10 mt-5 text-center">
  <!--Table-->
  <p class=" bg-danger text-white p-2">Product/Parts Details</p>
  <?php
...
<div class='float-right'><a class="btn btn-danger box" href="addproduct.php"><i class="fas fa-plus fa-2x"></i></a>
</div>
