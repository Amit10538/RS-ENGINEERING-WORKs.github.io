   ...
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">  <!-- start profile area 1nd column-->
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      <li class="nav-item">
       <a class="nav-link text-dark <?php if(PAGE == 'RequesterProfile') { echo 'active'; } ?>" href="RequesterProfile.php">
        <i class="fas fa-user text-dark"></i>
        Profile <span class="sr-only">(current)</span>
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link  text-dark<?php if(PAGE == 'SubmitRequest') { echo 'active'; } ?>" href="SubmitRequest.php">
        <i class="fab fa-accessible-icon text-dark"></i>
        Submit Request
       </a>
      </li>
      <!-- <li class="nav-item">
       <a class="nav-link text-dark <?php if(PAGE == 'CheckStatus') { echo 'active'; } ?>" href="CheckStatus.php">
        <i class="fas fa-align-center text-dark"></i>
        Service Status
       </a>
      </li> -->
      <li class="nav-item">
       <a class="nav-link text-dark <?php if(PAGE == 'Requesterchangepass') { echo 'active'; } ?>" href="Requesterchangepass.php">
