...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <b><span>RS Managment System</span></b>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>Welcome To RS Engineering Work's</span>
  </p>
